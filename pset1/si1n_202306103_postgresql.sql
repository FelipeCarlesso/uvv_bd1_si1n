...
--EXCLUSÃO DO BANCO DE DADO E USUÁRIO CASO EXISTEM--
...
\c 'postgres://felipe:1234@localhost/postgres'
;
...
--CRIAÇÃO DO SCHEMA--
CREATE SCHEMA lojas AUTHORIZATION felipe
;

--MUDANDO O SEARCH_PATH PARA O USUÁRIO--
